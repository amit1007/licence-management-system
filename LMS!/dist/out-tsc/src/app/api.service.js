...
var apiUrl = "/api";
var apiQlikUserURL = "/Qlik";
var apiQlIntentGenURL = "/Intent";
var euserUrl = "/euser";
var subUrl = "/subuser";
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getEuser = function () {
        return this.http.get(euserUrl, httpOptions).pipe(operators_1.map(this.extractData), operators_1.catchError(this.handleError));
    };
    ApiService.prototype.postEuser = function (data) {
        return this.http.post(euserUrl, data, httpOptions)
            .pipe(operators_1.catchError(this.handleError));
    };
    ApiService.prototype.postSubuser = function (data) {
        return this.http.post(subUrl, data, httpOptions)
            .pipe(operators_1.catchError(this.handleError));
    };
